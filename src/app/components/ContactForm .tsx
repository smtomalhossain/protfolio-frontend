  ...
  return (
    <section className="container mx-auto py-24">
      <div className="text-center mb-10">
        <span className="block text-blue-500 text-lg font-bold mb-5">
          Get in Touch
        </span>
        <h2 className="text-3xl font-bold mb-4">
          Let's <span className="text-indigo-600 border-b-4 border-gray-400">Connect</span>
        </h2>
        <p className="mt-2 text-lg  text-gray-500 font-medium max-w-xl mx-auto">
          Have a project in mind or just want to say hello? Feel free to reach out to me through the form below. I'm always excited to discuss new opportunities and ideas.
        </p>
      </div>
